...
IT_category = Category("Information Technology (IT)", [
    Category("Artificial Intelligence (AI)", [
        Category("Machine Learning (ML)", [
            Category("Deep Learning (DL)", [
                Category("Artificial Neural Networks (ANN)", [
            ...
            Category("Supervised Learning", [
                ...
                Category("Regression Techniques", [
                    ...
                    Category("Segmented (piecewise) regression")
                ]),
            ...
            Category("Unsupervised Learning", [
                ...
                Category("Dimensionality Reduction Techniques", [
                    ...
                    Category("Multidimensional Scaling (MDS)"),
                    Category("Autoencoders")
                ])
            ]),
            Category("Reinforcement Learning", [
                ...
                Category("Q-learning"),
                Category("Deep Q-network (DQN)"),
                Category("Markov Decision Processes (MDP)")
            ]),
...
generate_ascii_tree(IT_category)
